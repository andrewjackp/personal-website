...
<div class="wrestling-ring two">
					...
					<li class='wrestler-list-item'>
						<article class='wrestler-card'>
							<picture class='poster'>
								<img src="images/misawa.jpg" alt="pics">
							</picture>

							<div class="info">
								<span class='media-links title'>Mitsuharu Misawa</span>
								<p class='sub-title'>Thee Guy</p>
								<p class='caption'>Perfect all around wrestler</p>
								<a class='button' href="#">link here</a>
							</div>
							</article>
					</li>
